...
window.SITE_DATA = {
  ...
  education: {
    videos: {
      core: {
        items: [
          { title: 'Core Content Video 1', url: 'https://www.youtube.com/watch?v=1egEksqrtMo' },
          { title: 'Core Content Video 2', url: 'https://www.youtube.com/watch?v=1egEksqrtMo' },
          { title: 'Core Content Video 3', url: 'https://www.youtube.com/watch?v=1egEksqrtMo' }
        ],
        moreUrl: 'https://www.youtube.com/@PediatricPOCUS/videos'
      },
      expert: {
        items: [
          { title: 'Meet the Expert - Session 1', url: 'https://www.youtube.com/watch?v=1egEksqrtMo' },
          { title: 'Meet the Expert - Session 2', url: 'https://www.youtube.com/watch?v=1egEksqrtMo' },
          { title: 'Meet the Expert - Session 3', url: 'https://www.youtube.com/watch?v=1egEksqrtMo' }
        ],
        moreUrl: 'https://www.youtube.com/@PediatricPOCUS/playlists'
      },
      pepec: {
        items: [
          { title: 'PEPEC Training Module 1', url: 'https://www.youtube.com/watch?v=1egEksqrtMo' },
          { title: 'PEPEC Training Module 2', url: 'https://www.youtube.com/watch?v=1egEksqrtMo' },
          { title: 'PEPEC Training Module 3', url: 'https://www.youtube.com/watch?v=1egEksqrtMo' }
        ],
        moreUrl: 'https://www.youtube.com/@PediatricPOCUS/playlists'
      }
    },
