...
window.SITE_DATA = {
  ...
  research: {
    currentStudies: [
      {
        ...
        end_date: null,
        keywords: ['Cardiac', 'Emergency Medicine', 'Pediatrics', 'Multi-center'],
    ...
    recruitingStudies: [
      ...
      },
      {
        ...
        eligibility_criteria: 'Pediatric emergency medicine fellows and attending physicians',
        current_enrollment: 42,
        enrollment_target: 100,
        study_url: 'https://example.com/training-study',
        contact_email: 'training.study@example.com'
      }
    ],
    projects: [
      {
    ...
    opportunities: [
      {
        ...
        description: 'Lead research initiatives at your institution and contribute to multi-center studies.',
        contact_email: 'research@pediatricpocus.org'
      },
      {
        title: 'Data Contributor',
        type: 'Clinical Data',
        description: 'Share anonymized clinical data and imaging studies to support research databases.',
        contact_email: 'research@pediatricpocus.org'
      },
      {
        title: 'Protocol Developer',
        type: 'Clinical Guidelines',
        description: 'Help develop evidence-based protocols and clinical practice guidelines.',
        contact_email: 'research@pediatricpocus.org'
      }
    ]
  },
    ...
    boardMembers: [
      {
        ...
        image_url: 'https://images.pexels.com/photos/5452274/pexels-photo-5452274.jpeg'
      },
      {
  ...
  globalHealth: {
    partners: [
      ...
      {
        name: 'Latin America POCUS Network',
        country: 'Multiple',
        region: 'Latin America',
        description: 'Collaborative network supporting POCUS education and implementation across Latin American pediatric hospitals.',
        partner_type: 'Regional Network',
        contact_name: 'Dr. Maria Rodriguez',
        contact_email: 'latam@pocusnetwork.org',
        logo_url: 'https://images.pexels.com/photos/3184325/pexels-photo-3184325.jpeg',
        start_date: '2020-06-01',
        is_active: true
      },
      {
        name: 'Southeast Asia Medical Education',
        country: 'Thailand',
        region: 'Southeast Asia',
        description: 'Training program focused on building local POCUS expertise and sustainable education infrastructure.',
        partner_type: 'Educational Partnership',
        contact_name: 'Dr. Somchai Patel',
        contact_email: 'sea@medicaledu.org',
        logo_url: 'https://images.pexels.com/photos/3184418/pexels-photo-3184418.jpeg',
    ...
    programs: [
      {
        title: 'Mobile POCUS Training Units',
        description: 'Deploying mobile training units equipped with ultrasound machines to remote areas, providing hands-on training for local healthcare providers.',
        location: 'Sub-Saharan Africa',
        impact_metrics: {
          providers_trained: 450,
          facilities_reached: 85,
          patients_impacted: 12000
        }
      },
      {
        title: 'Telemedicine POCUS Consultation',
        description: 'Real-time remote consultation service connecting local providers with POCUS experts for difficult cases and ongoing education.',
        location: 'Global',
        impact_metrics: {
          consultations: 1200,
          countries_served: 28,
  ...
  education: {
    videos: {
      core: [
        { title: 'Core Content Video 1', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '10:25' },
        { title: 'Core Content Video 2', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '8:15' },
        { title: 'Core Content Video 3', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '12:40' },
        { title: 'Core Content Video 4', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '9:30' },
        { title: 'Core Content Video 5', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '11:20' }
      ],
      expert: [
        { title: 'Meet the Expert - Session 1', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '15:45' },
        { title: 'Meet the Expert - Session 2', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '18:20' },
        { title: 'Meet the Expert - Session 3', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '14:55' },
        { title: 'Meet the Expert - Session 4', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '16:30' },
        { title: 'Meet the Expert - Session 5', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '17:10' }
      ],
      pepec: [
        { title: 'PEPEC Training Module 1', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '13:25' },
        { title: 'PEPEC Training Module 2', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '11:50' },
        { title: 'PEPEC Training Module 3', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '14:15' },
        { title: 'PEPEC Training Module 4', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '12:35' },
        { title: 'PEPEC Training Module 5', url: 'https://www.youtube.com/watch?v=1egEksqrtMo', duration: '15:00' }
      ]
    },
    upcomingEvents: [
      {
    ...
    papers: [
      {
        ...
        pdf_url: 'https://example.com/papers/best-practices.pdf'
      },
      {
        title: 'Advanced Techniques in Pediatric Cardiac Ultrasound',
        authors: 'Brown A, Davis L, Martinez R',
        publication_year: 2024,
    ...
    resources: [
      { title: 'Quick Reference Guide', url: 'https://example.com/resources/quick-guide', icon_name: 'document' },
      { title: 'Video Library', url: 'https://example.com/resources/videos', icon_name: 'video' },
      { title: 'Image Database', url: 'https://example.com/resources/images', icon_name: 'photo' },
      { title: 'Protocol Templates', url: 'https://example.com/resources/protocols', icon_name: 'clipboard' },
      { title: 'CME Resources', url: 'https://example.com/resources/cme', icon_name: 'certificate' },
      { title: 'Mobile Apps', url: 'https://example.com/resources/apps', icon_name: 'device' }
    ],
    fellowshipPrograms: [
      {
        name: 'Pediatric Emergency Medicine POCUS Fellowship',
        institution: "Children's Hospital",
        duration: '1 year',
        description: 'Comprehensive fellowship program focused on advanced pediatric point-of-care ultrasound training.',
        website_url: 'https://example.com/fellowship',
        contact_email: 'fellowship@example.com',
        year_started: 2020,
        num_ultrasound_faculty: 6,
        ultrasound_faculty: ['Dr. John Smith', 'Dr. Sarah Johnson', 'Dr. Michael Chen', 'Dr. Emily Davis', 'Dr. Robert Wilson', 'Dr. Maria Garcia'],
        program_structure: 'Combined with Emergency Medicine',
        rotations: ['Pediatric Emergency Department', 'Pediatric ICU', 'Neonatology', 'Cardiology', 'Radiology'],
        fellowship_length: '12 months',
        salary: '$65,000 - $75,000',
        additional_funds: '$5,000 conference and education allowance',
        num_clinical_hours: '16-20 hours per week',
        other_duties: 'Teaching responsibilities, research projects, quality improvement initiatives',
        num_sites: 2,
        num_positions_per_year: 2,
        additional_opportunities: 'International exchange programs, advanced certifications, research collaborations',
        educational_experience: 'Weekly didactic sessions, hands-on scanning workshops, case conferences',
        image_review: 'Daily image review sessions with faculty mentors',
        application_deadline_date: '2025-01-15'
      }
    ]
  },
  ...
  navigation: {
    items: [
      ...
      { label: 'Global Health', path: '/global-health' },
