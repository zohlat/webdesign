...
window.SITE_DATA = {
  ...
  upcomingEvents: [
    {
      title: 'Annual P2 Conference 2024',
      date: 'March 15-17, 2024',
      location: 'Chicago, IL',
      description: 'Join us for our annual conference featuring the latest in pediatric POCUS research and education.',
      registrationUrl: '#'
    },
    {
      ...
      date: 'October 2024',
      location: 'Virtual',
      description: 'Monthly webinar series covering advanced pediatric POCUS techniques.',
      registrationUrl: '#'
    },
    {
      title: 'SonoSurf Workshop',
      date: 'December 2024',
      location: 'San Diego, CA',
      description: 'Hands-on workshop combining surfing and ultrasound education.',
      registrationUrl: '#'
    }
  ],
